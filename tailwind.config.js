	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				fillcheck:
					'fillCheck 0.6s ease-in-out 0.4s forwards, scaleCheck 0.3s ease-in-out 0.9s both',
				strokecheck:
					'strokeCheck 0.8s cubic-bezier(0.65, 0, 0.45, 1) forwards',
				tickcheck:
					'strokeCheck 0.5s cubic-bezier(0.65, 0, 0.45, 1) 0.8s forwards',
				progressbar: 'moveProgress 5s linear infinite',
				fliptop:
					'flipTop 0.3s cubic-bezier(0.37, 0.01, 0.94, 0.35) both',
				flipbottom:
					'flipBottom 0.6s cubic-bezier(0.15, 0.45, 0.28, 1) both',
